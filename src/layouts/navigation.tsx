      ...
      <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 bg-white text-sm border-b border-gray-200 dark:bg-slate-800 dark:border-slate-900 transition-all duration-500">
        <nav className="w-full px-16 py-4 sm:flex sm:items-center sm:justify-between">
          <div className="flex items-center justify-between">
            ...
            >
              <BoltIcon className="h-12 w-12 p-2.5 bg-sky-700 text-white rounded-full dark:text-slate-800" />
              Wattson
            </Link>
          </div>
          <div
          ...
          >
            <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
              <Link
                to="/settings"
                className="flex items-center justify-between gap-4 font-medium text-gray-600 hover:text-gray-900 dark:text-slate-400 dark:hover:text-slate-100 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              >
